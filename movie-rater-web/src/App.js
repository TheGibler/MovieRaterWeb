  ...
  return (
      <div className="App">
        ...
        <div className="layout">
          <MovieList movies={this.state.movies} movieClicked={this.loadMovie}  newMovie={this.newMovie}
            movieDeleted={this.movieDeleted} editClicked={this.editClicked} token={this.state.token}/>
            <div>
